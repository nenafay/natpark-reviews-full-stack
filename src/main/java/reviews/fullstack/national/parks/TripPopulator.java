...
public class TripPopulator implements CommandLineRunner{
	...
	public void run(String...args) throws Exception {
		...
		Tag family = tagRepo.save(new Tag("family-friendly", acadia, adirondack, wayne, grandCanyon, yosemite, whitemts));
		Tag wildlife = tagRepo.save(new Tag("wildlife", acadia, adirondack, wayne, grandCanyon, yosemite, joshuaTree, sequoia, whitemts));
		Tag science = tagRepo.save(new Tag("science", grandCanyon, escalante, joshuaTree, deathValley));
		Tag tent = tagRepo.save(new Tag("tent-camping", grandCanyon, acadia, adirondack, wayne, whitemts, joshuaTree, deathValley));
		Tag secluded = tagRepo.save(new Tag("secluded", acadia, wayne, whitemts, escalante, deathValley));
		Tag congested = tagRepo.save(new Tag ("congested", sequoia, yosemite, grandCanyon));
	}	
}
